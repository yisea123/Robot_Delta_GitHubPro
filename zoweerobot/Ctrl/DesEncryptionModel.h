#ifndef DESENCRYPTIONMODEL_H
#define DESENCRYPTIONMODEL_H
...
public:
    ...
    void Des_Run(char* Out, char* In, bool Type=ENCRYPT);   /**< G代码源文件text */
    QString Des_Run(QString In, bool Type=ENCRYPT);   /**< G代码源文件text */
    void Des_SetKey(const char Key[8]);    /**< G代码源文件text */
private:
    void F_func(bool In[32], const bool Ki[48]);   /**< G代码源文件text */
