...
/*************************************************
  ∫Ø ˝√˚≥∆£∫MotionControllerModule()
  ∫Ø ˝π¶ƒ‹£∫MotionControllerModuleππ‘Ï∫Ø ˝
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫MotionControllerModule(QList<InfoUI *>& u, SystemSchedule* ss)
  ∫Ø ˝π¶ƒ‹£∫MotionControllerModuleππ‘Ï∫Ø ˝
   ‰»Î≤Œ ˝£∫u UI¡¥±Ì
           ss  SystemScheduler÷∏’Î
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
**************************************************/
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫~MotionControllerModule()
  ∫Ø ˝π¶ƒ‹£∫MotionControllerModuleŒˆππ∫Ø ˝
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫initMotionControllerModule()
  ∫Ø ˝π¶ƒ‹£∫MotionControllerModule≥…‘±±‰¡ø≥ı ºªØ
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫‘⁄÷¥––œµÕ≥∏¥Œª ±–Ë“™µ˜”√
...
void MotionControllerModule::initMotionControllerModule()
{
    ...
    m_SetParmStatus = 127;//0111 1111B  À˘”–≤Œ ˝…Ë÷√
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫initModule(QList<InfoUI *>& u)
  ∫Ø ˝π¶ƒ‹£∫Module≥ı ºªØ º”‘ÿUI º”‘ÿ…Ë±∏
   ‰»Î≤Œ ˝£∫u UI¡¥±Ì
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫findUIResource(QList<InfoUI *>& u, ErrorInfo& e)
  ∫Ø ˝π¶ƒ‹£∫‘⁄œµÕ≥µƒÀ˘”–◊¢≤·µƒUIœ¬£¨—∞’“MotionControllerModule π”√µƒUI
   ‰»Î≤Œ ˝£∫u UI¡¥±Ì
           e  ¥ÌŒÛ–≈œ¢
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
...
int MotionControllerModule::findUIResource(QList<InfoUI *>& u, ErrorInfo& e)
{
    for(int i = 0; i < u.size(); i++)
    {
        ...
        {
            if(u.at(i)->nModulesUser[j] == MOTION_CONTROLLER_ID)   /* ∆•≈‰∏√Module */
               m_UIs.append(u.at(i));
        }
    }
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫getMachiningStateUI()
  ∫Ø ˝π¶ƒ‹£∫ªÒ»°◊‘∂Øº”π§ΩÁ√Ê÷∏’Î
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫clearGCodeDataList()
  ∫Ø ˝π¶ƒ‹£∫«Â≥˝m_GCodeDataList¡¥±Ì
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
void MotionControllerModule::parseNGFileModel()
{
    ...
    if(pp != NULL)
    {
        ...
        {
            clearGCodeDataList();
            /* emit¥ÌŒÛ–≈∫≈∏¯system£¨systemœ‡”¶µƒ≤€Ω” ‹£¨À˘”–µƒ–≈œ¢‘⁄m_errInfo*/
    ...
    /* ∑Ω Ω2£∫‘⁄œﬂ≥Ã£®MotionControllerModule::run()£©÷–÷¥––»´≤øΩ‚ŒˆG¥˙¬Î */
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫setEmulationStatus(CAutoMachiningStateUi::MotionRunStatue s)
  ∫Ø ˝π¶ƒ‹£∫…Ë÷√◊‘∂Øº”π§ΩÁ√Êµƒ‘À––◊¥Ã¨
   ‰»Î≤Œ ˝£∫s£∫◊‘∂Øº”π§ΩÁ√Êµƒ‘À––◊¥Ã¨
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
**************************************************/
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫setProcessBarValue(int s)
  ∫Ø ˝π¶ƒ‹£∫…Ë÷√◊‘∂Øº”π§ΩÁ√Êµƒº”π§Ω¯∂»
   ‰»Î≤Œ ˝£∫s£∫◊‘∂Øº”π§ΩÁ√Êµƒº”π§Ω¯∂»
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
**************************************************/
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫absorbMotionModule(QString msg, QString arg)
  ∫Ø ˝π¶ƒ‹£∫≤€∫Ø ˝  ¥¶¿Ì¿¥◊‘emitMotionModuleSignal(QString, QString)µƒ–≈∫≈
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
  ±∏    ◊¢£∫
...
void MotionControllerModule::absorbMotionModule(QString msg, QString arg)
{
...

    {
           ...
           /* if (msg == "system reset")
            {
                //∏˜÷÷«Â¿Ìπ§◊˜
                systemReset();
                m_pScheduler->recvRunInfoFromAllModules("œµÕ≥∏¥Œª");
            }
            else if (msg == "clear error")
            {
                ...
                m_pScheduler->recvRunInfoFromAllModules("«Â≥˝¥ÌŒÛ");
			...
			&&(m_WorkStatus != MOTION_WORK_ERROR_WAITTING))
                     {
			  		...
			  		qDebug()<<"procMotionModel end";
		                    //m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("º”π§∆Ù∂Ø"));
		                    setProcessBarValue(0);
		                    //m_pScheduler->writeMsgToStatusBar(QString::fromLocal8Bit("º”π§∆Ù∂Ø"));
		                    m_bisInPauseWaittingStatus = false;
				     m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("—≠ª∑º”π§∆Ù∂Ø"));
		                }
                    		
				 else
				{
				        QMessageBox::information(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("Œ¥ πƒ‹ªÚŒ¥¥¶”⁄◊‘∂Øƒ£ Ω"));
				        
				}
                    		//m_pScheduler->writeMsgToStatusBar(QString::fromLocal8Bit("—≠ª∑º”π§∆Ù∂Ø"), STATUSBAR_STATUS_ON_INFO);
                     }
			else
			{
			        QMessageBox::information(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("≥Ã–Ú‘À––÷–£¨«Îœ»Õ£÷π£°"));
			        qDebug()<<"œµÕ≥◊¥Ã¨"<<m_WorkStatus;
			}
                ...
                else
                {
                    ...
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("—≠ª∑º”π§»°œ˚"));
                    //m_pScheduler->writeMsgToStatusBar(QString::fromLocal8Bit("—≠ª∑º”π§»°œ˚"), STATUSBAR_STATUS_OFF_INFO);
                }
            }
        ...
        {
            QMessageBox::information(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("œµÕ≥¥¶”⁄º±Õ£◊¥Ã¨÷–£¨«Îœ»œ˚≥˝º±Õ££°"));
        }
    }
}
...
/*************************************************
  ∫Ø ˝√˚≥∆£∫absorbManualMotionModule(QString msg, QString arg)
  ∫Ø ˝π¶ƒ‹£∫≤€∫Ø ˝  ¥¶¿Ì¿¥◊‘emitMotionModuleSignal(QString, QString)µƒ–≈∫≈
   ‰»Î≤Œ ˝£∫
   ‰≥ˆ≤Œ ˝£∫
  ∑µ ªÿ ÷µ£∫
...
void MotionControllerModule::absorbManualMotionModule(QString msg, QString arg)
{
    if (m_WorkStatus == MOTION_WORK_MANUAL_SET||m_WorkStatus == MOTION_WORK_IDLE || m_WorkStatus == MOTION_WORK_MANUAL_MOTION || m_WorkStatus == MOTION_WORK_JOG_MOTION)
    {
        ...
        if (msg == "xPMotion")
        {
            if (isServoEnable())// && isAxisXYEnableMove(!m_bIsDebugMode)
            {
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    //m_pScheduler->recvRunInfoFromAllModules("XËΩ¥ÁßªÂä + arg + "mm");
			return;
                }
                else
                {
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("ËØ∑Á≠âÂæÖÁßªÂä®Êåá‰ª§ÂÆåÊàê[ ËøêË°åÁä∂ÊÄÅÔºö%1ÔºåÊåá‰ª§Ôºö%2ÔºåÂÜÖÂÆπÔºö%3 ]").arg(m_ManualStatus).arg(msg).arg(arg));
                    return;
                }
            }
        }
        ...
        else if (msg == "yPMotion")
        {
            if (isServoEnable())// && isAxisXYEnableMove(!m_bIsDebugMode)
            {
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    m_ManualStatus = MANUAL_START;
                    m_WorkStatus = MOTION_WORK_MANUAL_MOTION;
                    //m_pScheduler->recvRunInfoFromAllModules("YËΩ¥ÁßªÂä + arg + "mm");
                    return;
                }
                else
                {
        ...
        else if (msg == "zPMotion")
        {
            if (isServoEnable())// && isAxisXYEnableMove(!m_bIsDebugMode)
            {
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    m_ManualStatus = MANUAL_START;
                    m_WorkStatus = MOTION_WORK_MANUAL_MOTION;
                    //m_pScheduler->recvRunInfoFromAllModules("ZËΩ¥ÁßªÂä + arg + "mm");
                    return;
                }
                else
                {
        ...
        else if (msg == "rPMotion")
        {
            if (isServoEnable())// && isAxisXYEnableMove(!m_bIsDebugMode)
            {
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    m_ManualStatus = MANUAL_START;
                    m_WorkStatus = MOTION_WORK_MANUAL_MOTION;
                    //m_pScheduler->recvRunInfoFromAllModules("RËΩ¥ÁßªÂä + arg + "mm");
                    return;
                }
                else
                {
	  ...
	  else if(msg=="setParamer")
	  {
	        if(arg=="all")
	  	{
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("…Ë÷√≤Œ ˝"));
                    return;
                }
                else
                {
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("Ãıº˛≤ª¬˙◊„£¨…Ë÷√ ß∞‹"));
                    return;
                }
            }
            else if(arg=="linkparam")
	  	{
                if (m_ManualStatus == MANUAL_IDLE)
                {
                    ...
                    m_WorkStatus = MOTION_WORK_MANUAL_SET;
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("…Ë÷√¡¨∏À≤Œ ˝"));
                    return;
                }
                else
                {
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("Ãıº˛≤ª¬˙◊„£¨…Ë÷√¡¨∏À ß∞‹"));
                    return;
                }
            }
	  }
	  ...
	  else if(msg == "clear")
	 {
          
            {
		     ...
		     m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("«Â≥˝¥ÌŒÛ"));
                    m_pScheduler->writeMsgToStatusBar("");	
                    return;
                }
                else
                {
                    m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("Ãıº˛≤ª¬˙◊„£¨«Â≥˝ ß∞‹"));
                    return;
                }
            }
	...
	else if(msg == "GetVersion")
	 {
        ...
        else if (msg == "servoEnable")
        {
            ...
            if (arg == "yes")
            {
                ...
                m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("À≈∑˛∆Ù∂Ø"));
                //m_pScheduler->writeMsgToStatusBar(QString::fromLocal8Bit("À≈∑˛∆Ù∂Ø"));
            }
            else
            {
                m_bIsServoEnable = false;
                m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("À≈∑˛πÿ±’"));
                //m_pScheduler->writeMsgToStatusBar(QString::fromLocal8Bit("À≈∑˛πÿ±’"));
            }
        }
		...
		else if(msg == "getteachpoint")
		{
		...
		else if(msg == "movetopoint")
		 {
				...
				&&(m_WorkStatus != MOTION_WORK_ERROR_WAITTING))
					...
					{
					        QMessageBox::information(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("«Îœ»ÃÌº” æΩÃµ„£°"));
					        qDebug()<<" æΩÃµ„–Ú∫≈"<<m_pScheduler->m_pSystemParameter->teachpoint[m_movepointnum].index;
						return ;
					}
    ...
    {
        QMessageBox::information(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("œµÕ≥◊¥Ã¨≤ª¬˙◊„÷¥––∏√÷∏¡Ó£°"));
        qDebug()<<"œµÕ≥◊¥Ã¨"<<m_WorkStatus;
    }
    ...
    if(m_pEmulationModelHandler != NULL)
    {
	 ...
	 qDebug()<<"startupProcEmulationController";
        ...
        if(m_pEmulationModelHandler->startupProcEmulationController(this, &m_GCodeDataList, m_pProcessCacheHandler, m_errInfo))
        {
            ...
            //m_GCodeRunSerialNum = 0;//∏’ø™ ºº”π§Œƒº˛ ±≥ı ºªØ∏√÷µ,”…”⁄MOTION_WORK_NORMAL_START◊¥Ã¨Õ¨ ±”√”⁄‘›Õ£∫Õ‘›Õ£ª÷∏¥£¨π Ω´≥ı ºªØ∑≈‘⁄¥À¥¶
...
void MotionControllerModule::run()
{
    ...
    {
        m_errInfo.insertDebug(DEBUG_SERIOUS_ERROR, "TCP Socket ¥¥Ω®≤ª≥…π¶£¨«ÎºÏ≤ÈÕ¯¬Á¡¨Ω”≤¢÷ÿ–¬∆Ù∂Ø£°");
        m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
    ...
    {
        m_errInfo.insertDebug(DEBUG_SERIOUS_ERROR, "Socket ¥¥Ω®≤ª≥…π¶£¨«ÎºÏ≤ÈÕ¯¬Á¡¨Ω”≤¢÷ÿ–¬∆Ù∂Ø£°");
        m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
...
void MotionControllerModule::doMotion()
{
    ...
    case MOTION_WORK_NORMAL_BOOT:
        ...
        {
            m_pScheduler->recvRunInfoFromAllModules("∑¢ÀÕ’˝≥£ø™ª˙Õ®÷™");
   ...
   case MOTION_WORK_NORMAL_START:
        if (((MotionControllerDevice *)m_pDevice)->setMotionMode(2))//ÊîπÂèòËøêÂä®Áä∂ÊÄÅ
        {
		...
		m_nDelayTime=0;
            ...
            m_pScheduler->recvRunInfoFromAllModules("∆Ù∂ØFIFO‘À∂Ø≥…π¶");
        }
    ...
    case MOTION_WORK_NORMAL_PROCESS:
    {
	    ...
	    if (m_GCodeRunSerialNum < 0)
            {
                m_errInfo.insertDebug(DEBUG_SERIOUS_ERROR, "action ‘À––º∆ ˝¥ÌŒÛ£°");
                m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
                m_pScheduler->writeMsgToStatusBar(m_errInfo.toString());
                m_WorkStatus = MOTION_WORK_ERROR_WAITTING;
                break;
        ...
        else
        {
		 ...
		 nCurrentLineSerialNum=0;
	        qDebug()<<"stop the motion";
                ...
                //m_pProcessCacheHandler->m_nLastPartGCodeNum = m_nLastPartGCodeNum;
                m_pProcessCacheHandler->m_bIsManualMotion = true;
                m_pScheduler->recvRunInfoFromAllModules("Âä†Â∑•ÂÆåÊàê");
            }
            else 
            {
            	    
		    if (m_pScheduler->m_pSystemParameter->sys_ctrl.decode_id>= nCurrentLineSerialNum)//(m_nCurCtlRunId >= m_MotionCodeList.last()->m_nCodeId)//ÊéßÂà∂Âô®ÂèçÈ¶àÂÆåÊàê
	            {
    ...
    case MOTION_WORK_NORMAL_END:
	 ...
	 m_nDelayTime=0;
        if (m_bisCycleRun)//Âæ™ÁéØÂä†Â∑•
        {
                    m_GCodeRunSerialNum=0;
			nCurrentLineSerialNum=0;
                    m_WorkStatus = MOTION_WORK_NORMAL_PROCESS;
                    //m_pScheduler->recvRunInfoFromAllModules(tr("Âæ™ÁéØÂä†Â∑•Á¨¨%1Ê¨°ÂÆåÊàêÔºåÂÖ±%2Ê¨°").arg(m_nCurCircleRunNum).arg(m_nCricleRunCnt));
                    //if((((MotionControllerDevice *)m_pDevice)->m_netctrl->gb_ctrl.sendinput[0])&0x2)
		     if(m_pScheduler->m_pSystemParameter->sys_ctrl.sendinput[0]&0x2)
		     {
		     	     m_WorkStatus = MOTION_WORK_IDLE;
...
//                    m_pProcessCacheHandler->m_nLastPartGCodeNum = m_nLastPartGCodeNum;
    ...
    case MOTION_WORK_EMERGENCY_STOP:
        ...
        {
            m_pScheduler->recvRunInfoFromAllModules("ΩÙº±Õ£÷π÷∏¡Ó∑¢ÀÕ≥…π¶");
            m_WorkStatus = MOTION_EMERGENCY_STOP_WAITTING;//MOTION_WORK_IDLE;
        }
        else
        {
            m_pScheduler->recvRunInfoFromAllModules("ΩÙº±Õ£÷π÷∏¡Ó∑¢ÀÕ ß∞‹");
            if(m_errInfo.e_type != DEBUG_NO_ERROR)
            {
                m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
                m_WorkStatus = MOTION_WORK_ERROR_WAITTING;
    ...
    case MOTION_RE_CONNECT_NET:
        {
            ...
            {
                m_pScheduler->recvRunInfoFromAllModules("Õ¯¬Á÷ÿ¡¨≤ª≥…π¶");
                //m_pScheduler->writeMsgToStatusBar("Õ¯¬Á÷ÿ¡¨≤ª≥…π¶");//domotion()–Ë“™‘⁄÷˜œﬂ≥Ã≤≈ƒ‹≤ªª·±®¥Ì£°£®’‚¿Ô‘› ±Ω´run()¥¥Ω®µƒœﬂ≥Ã“∆∂ØµΩ÷˜œﬂ≥Ã£©
                m_WorkStatus = MOTION_NO_CONNECT_NET;
            }
        }break;
    case MOTION_CLOSE_CONNECT_NET:
        ...
        {
            //m_pScheduler->recvRunInfoFromAllModules("∂œø™Õ¯¬Á¡¨Ω”≥…π¶");
            //m_pScheduler->writeMsgToStatusBar("∂œø™Õ¯¬Á¡¨Ω”≥…π¶");
            m_WorkStatus = MOTION_NO_CONNECT_NET;
        }
        else
        {
            m_pScheduler->recvRunInfoFromAllModules("∂œø™Õ¯¬Á¡¨Ω” ß∞‹");
            //m_pScheduler->writeMsgToStatusBar("∂œø™Õ¯¬Á¡¨Ω” ß∞‹");
            m_WorkStatus = MOTION_WORK_IDLE;
        }
        break;
    ...
    case MOTION_WORK_SERVO_ENABLE:
        if (((MotionControllerDevice *)m_pDevice)->axisEnable(m_bIsServoEnable))
        {
            ...
            //m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("‰º∫ÊúçÂêØÂä®/ÂÖ≥Èó≠Êåá‰ª§ÂèëÈÄÅÊàêÂä));
        }
        break;
    ...
    case MOTION_CLEAR_ERROR:
        ...
        {
            m_pScheduler->recvRunInfoFromAllModules("«Â≥˝øÿ÷∆∆˜◊¥Ã¨≥…π¶");
            m_WorkStatus = MOTION_WORK_IDLE;
        }
        else
        {
            m_pScheduler->recvRunInfoFromAllModules("«Â≥˝øÿ÷∆∆˜◊¥Ã¨ ß∞‹");
            if(m_errInfo.e_type != DEBUG_NO_ERROR)
            {
                m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
                m_WorkStatus = MOTION_WORK_ERROR_WAITTING;
    ...
    case MOTION_EMERGENCY_STOP_CLEAR:
        ...
        {
            m_pScheduler->recvRunInfoFromAllModules("«Â≥˝øÿ÷∆∆˜º±Õ£◊¥Ã¨≥…π¶");
            m_WorkStatus = MOTION_WORK_NORMAL_BOOT;
        }
        else
        {
            m_pScheduler->recvRunInfoFromAllModules("«Â≥˝øÿ÷∆∆˜º±Õ£◊¥Ã¨ ß∞‹");
            if(m_errInfo.e_type != DEBUG_NO_ERROR)
            {
                m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
                m_WorkStatus = MOTION_WORK_ERROR_WAITTING;
...
bool MotionControllerModule::runOneActions()
{
    ...
    case ACTION_MG_TYPE:
        ...
        if (m_nMotionControllerRunNum + m_pProcessCacheHandler->m_nMCodeCnt - m_nLastPartGCodeNum == m_GCodeRunSerialNum)//µ»¥˝‘À––µΩµ±«∞Œª÷√
        {
            ...
            case 0://≥Ã–ÚÕ£÷π
                ...
                m_pScheduler->recvRunInfoFromAllModules("M00 ≥Ã–ÚÕ£÷π");
                //m_pScheduler->writeMsgToStatusBar("M00 ≥Ã–ÚÕ£÷π");
                break;
            case 1://—°‘ÒÕ£÷π
                if (m_bIsM01Effect)
                {
                    m_pScheduler->recvMsgFromWindows(MOTION_CONTROLLER_ID, "pause emulation");
                    m_pScheduler->recvRunInfoFromAllModules("M01 —°‘ÒÕ£÷π");
                    //m_pScheduler->writeMsgToStatusBar("M01 —°‘ÒÕ£÷π");
                }
                break;
            case 2://≥Ã–ÚΩ· ¯
            case 30://≥Ã–ÚΩ· ¯
                m_pScheduler->recvMsgFromWindows(MOTION_CONTROLLER_ID, "stop emulation");
                m_pScheduler->recvRunInfoFromAllModules("M02/M30 ≥Ã–ÚΩ· ¯");
                //m_pScheduler->writeMsgToStatusBar("M02/M30 ≥Ã–ÚΩ· ¯");
                break;
            case 13://≥Â—πƒ£ Ω∏¥Œª
                break;
            default:
   ...
   /* case ACTION_IO_TYPE:
    ...
    case ACTION_DELAY_TYPE:
        ...
        if (m_nDelayTimeSurplus <= 0)//≥ı ºªØ∏≥÷µ
        {
        ...
        if (m_nMotionControllerRunNum + m_pProcessCacheHandler->m_nMCodeCnt - m_nLastPartGCodeNum == m_GCodeRunSerialNum)//µ»¥˝‘À––µΩµ±«∞Œª÷√
        {
            ...
            if (m_nDelayTimeSurplus <= 0)//—” ± ±º‰µΩ£¨÷ÿªÿº”π§
            {
                m_GCodeRunSerialNum++;
                m_pProcessCacheHandler->m_nMCodeCnt++;
            }
           ...
           // if (m_pPlcControllerModuleHandle->getInputIOStatus(IO_CANTOOLCHANGE_SIGNAL_PLC_M))
            {
                ...
                else if (temp == 0)//ª∫≥Â«¯¬˙£¨÷ÿ–¬∑¢ÀÕ£¨ªπ‘≠¿€º∆◊¯±Í ˝æ›
                {
                    //m_pScheduler->recvErrMsgFromAllModules(m_errInfo);
    ...
    case ACTION_TOOL_ROTATE_TYPE:
        ...
        if (m_nMotionControllerRunNum + m_pProcessCacheHandler->m_nMCodeCnt - m_nLastPartGCodeNum == m_GCodeRunSerialNum)//µ»¥˝‘À––µΩµ±«∞Œª÷√
        {
           // if (m_pPlcControllerModuleHandle->getInputIOStatus(IO_ISROTATETOOL_SIGNAL_PLC_M))//≈–∂œ «∑Ò «◊™ƒ£
            {
                int temp = ((MotionControllerDevice *)m_pDevice)->runOneActions(m_GCodeActions->at(m_GCodeRunSerialNum), m_pProcessCacheHandler, m_pScheduler->getSystemParameterHandler(), m_errInfo);
                if (temp > 0)
                {
...
void MotionControllerModule::feedbackSystemState()
{
    ...
    if (timeCnt > 0)
    {
        if (timeCnt%4 == 0 && m_nClampAutoSearchStep == CAS_PRE_WORK)//º–«ØÀ—À˜∆⁄º‰≤ªªÒ»°◊¥Ã¨
        {
            if(((MotionControllerDevice *)m_pDevice)->getSts(&(m_pProcessCacheHandler->m_nMotionControllerSts), m_errInfo))
            {
                ...
                if ((m_pProcessCacheHandler->m_nMotionControllerSts & 0xffc00000) != 0)//¥•∑¢œﬁŒª
                {
                    //qDebug()<<"«Â≥˝œﬁŒª";
                    m_pScheduler->recvMsgFromWindows(MOTION_CONTROLLER_ID, "limit trigger");
                    ((MotionControllerDevice *)m_pDevice)->clearSts(m_errInfo);//«Â≥˝◊¥Ã¨
                }
            }
        }
        timeCnt--;
...
bool MotionControllerModule::isAxisVInRightPosition(double angle)
{
    ...
    {
        if (fabs(angle - m_pScheduler->getSystemParameterHandler()->m_mouldsParm.at(i).m_dPosAngle) < 0.1)//‘ –ÌŒÛ≤Ó0.1∂»
        {
            return true;
        }
    }
...
bool MotionControllerModule::isServoEnable()
{
     ...
     {
	   if (!m_bIsServoEnable)//if ((m_pProcessCacheHandler->m_nMotionControllerSts & checkflag) != 0)//‰º∫ÊúçÂêØÂä®
	    {
	    	m_bIsServoEnable=1;
        ...
        /* if (isShowMessageBox)
         {
             ...
             QMessageBox::warning(NULL, "Ë≠¶Âëä", "ÁîµÊú∫Êú™‰ΩøËÉ, QMessageBox::Yes, QMessageBox::Yes);
         }*/
         m_pScheduler->recvRunInfoFromAllModules(QString::fromLocal8Bit("µÁª˙Œ¥ πƒ‹£¨«Îœ»…œ πƒ‹£°"));
	 QMessageBox::warning(NULL, QString::fromLocal8Bit("æØ∏Ê"), QString::fromLocal8Bit("µÁª˙Œ¥ πƒ‹£¨«Îœ»…œ πƒ‹£°"));
         return false;
     }
}
...
/*bool MotionControllerModule::isServoEnable()
{
	   ...
	   if (m_bIsServoEnable)//if ((m_pProcessCacheHandler->m_nMotionControllerSts & checkflag) != 0)//‰º∫ÊúçÂêØÂä®
	    ...
	    else
	    {
	        ...
	        m_pScheduler->recvRunInfoFromAllModules("ÁîµÊú∫Êú™‰ΩøËÉΩÔºå‰∏çËÉΩÊâßË°å");
	        return false;
	    }
...
bool MotionControllerModule::isDingWeiXiaoEnable()
{
    ...
    {
        QMessageBox::information(NULL, tr("æØ∏Ê"), tr("∂®Œªœ˙Œ¥µΩŒª£°"));
        return false;
    }*/
    return true;
}
...
{
     return true;
    /*if (m_pPlcControllerModuleHandle->getInputIOStatus(IO_CANTOOLCHANGE_SIGNAL_PLC_M))//T÷·∞≤»´º‡≤‚
    {
        if (m_pProcessCacheHandler->m_curPoint.v < 1)
        {
            ...
            {
                QMessageBox::information(NULL, tr("æØ∏Ê"), tr("∞≤»´√≈√ª”–πÿ±’"));
                return false;
            }
        }
        else
        {
            QMessageBox::information(NULL, tr("æØ∏Ê"), tr("V÷·√ª”–‘⁄…œÀ¿µ„£°"));
            return false;
        }
    }
    else
